...
if($_SERVER['REQUEST_METHOD']=="POST"){
  $connection = new database();
    $result[] = $connection->loginVal($_POST['email'],$_POST['password']);
}
?>
<html lang="en">
<head>
                    ...
                    <div class="row gy-2 overflow-hidden">
                      ...
                      <div class="col-12">
                        <div class="d-flex gap-2 justify-content-between">
                          ...
                          <a href="forgotPass.php" class="link-primary text-decoration-none">Forgot password?</a>
                        </div>
                      </div>
                      <div class="col-12">
