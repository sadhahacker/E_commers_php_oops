...
$resultadmin = $connection->query($adminsql);
$resultuser = $connection->query($customersql);
$resultproduct = $connection->query($productsql);
$rowadmin = $resultadmin->fetch_all(MYSQLI_ASSOC);
$rowuser = $resultuser->fetch_all(MYSQLI_ASSOC);
$rowproduct = $resultproduct->fetch_all(MYSQLI_ASSOC);
?>
