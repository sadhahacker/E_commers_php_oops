...
$sqltotalamount = "SELECT SUM(total_amount) AS total_price FROM orders WHERE customer_id =".$_SESSION['id'];
$resultamount = $connection->query($sqltotalamount);
$amount = $resultamount->fetch_assoc();
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <!-- Include any additional PHP logic or include other files as needed -->
                    <p class="total font-weight-bold">Total Amount: <?php echo $amount['total_price']; ?></p>
                </div>
            </div>
        </div>
    </div>
